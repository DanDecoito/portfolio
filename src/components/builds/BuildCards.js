...
export default function BuildCards() {
    return (
        <article className='flex flex-col rounded-l items-center space-y-7 flex-shrink-0 shadow-2xl rounded-md border-black border-2 w-56 h-96 p-4 snap-center
